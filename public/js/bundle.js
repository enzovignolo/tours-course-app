...
},{"regenerator-runtime":"../../node_modules/regenerator-runtime/runtime.js"}],"login.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Succesfully logged OUT');
              window.setTimeout(function () {
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZW56b2V2aWdub2xvIiwiYSI6ImNraWhwdGNyYjF4dDQydHBvMWM4aXZ1N3EifQ.a0uPAi0laodlmzEdfMIIqA';
  ...
  locations.forEach(function (loc) {
    console.log(_typeof(loc.coordinates[0])); // Creates elements that will be assigned to the map as markers

    var el = document.createElement('div');
    el.className = 'marker'; // Assign the elements to new markers created

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }) //Set the locations where to place the markers
    .setLngLat(loc.coordinates) // Indicates wich map to assign the markers
    .addTo(map); // Extends the limits of the maps to the fit the coordinates
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/users/update-".concat(type === 'password' ? 'password' : 'user'),
              data: data
            });
...
var stripe = Stripe('pk_test_51Hyb7iFdrvCnvRLyyVDq9vPEb0lAWVPlQqawqOiR7A1qmBgsPQL1XaLusJt2eeoHukExWOzH5k19CFM7GRnxI2rD0090rtDwUG');
...
if (updateUserBtn) {
  updateUserBtn.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // THIS WILL CREATE A MULTIPART FORM DATA THAT WE NEED TO FILL UP WITH INFO BEFORE PASSING TO updateUserSettings
...
if (updatePasswordBtn) {
  updatePasswordBtn.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var password, newPassword, passwordConfirmation;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
